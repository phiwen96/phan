...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.9.1"
  WORKING_DIRECTORY "/Users/philipwenkel/GitHub/Phan/xbuild/_deps/catch-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.9.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.9.1")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/philipwenkel/GitHub/Phan/xbuild/_deps/catch-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/philipwenkel/GitHub/Phan/xbuild/_deps/catch-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
